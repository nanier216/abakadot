        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-14 md:pt-16 md:pb-20 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="max-w-xl">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed mb-10">
              PinDot is a cloud-connected, AI-driven Braille learning device
              that delivers independent, voice-guided tactile education at a
              price the world can afford.
            </p>
      ...
      <section className="py-14 md:py-20 relative overflow-hidden bg-gradient-to-br from-[#0d4f47] via-[#0f766e] to-[#134e4a]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="inline-block text-brand-orange text-xs font-bold uppercase tracking-widest mb-4">
              The Global Problem
            </span>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white leading-tight max-w-3xl mx-auto">
              Vision impairment is a global crisis. Assistive technology
              shouldn't be.
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-10">
            {[
              ...
              <div
                key={item.stat}
                className="bg-white/8 border border-white/15 rounded-2xl p-7 backdrop-blur-sm hover:bg-white/12 transition-all"
              >
                <div
                ...
                <div
                  className={`font-display font-bold text-4xl md:text-5xl mb-2 ${item.color}`}
                >
                  {item.stat}
                </div>
          ...
          <div className="bg-white/10 border border-white/20 rounded-2xl p-7 text-center max-w-3xl mx-auto">
            <p className="text-white text-lg md:text-xl font-display font-semibold leading-relaxed">
              PinDot costs{" "}
              <span className="text-brand-teal font-bold">₱11,000</span> — a
              fraction of what global alternatives demand, and built
              specifically for low- and middle-income communities.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg max-w-2xl mx-auto">
              Powered by an AI Spaced Repetition algorithm and a single-cell
              micro-solenoid Braille mechanism — no teacher required.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-4">
              {steps.map((step, i) => (
                ...
                >
                  ...
                  {/* Number + Icon node */}
                  <div
                    className={`relative w-[104px] h-[104px] ${step.bg} border-2 ${step.border} rounded-2xl flex flex-col items-center justify-center mb-5 shadow-sm`}
                  >
                    <span
                      className={`font-display font-bold text-xs ${step.color} mb-1 tracking-widest`}
                    >
                      {step.num}
                    </span>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed max-w-[200px] mx-auto">
                    {step.desc}
                  </p>
          ...
          <div className="mt-16 grid sm:grid-cols-2 gap-5">
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-100 dark:border-slate-700 shadow-sm flex gap-5 items-start">
              ...
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  Characters are re-queued based on each learner's error
                  patterns, maximizing long-term retention with minimal session
                  time.
                </p>
              </div>
            </div>
            <div className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-100 dark:border-slate-700 shadow-sm flex gap-5 items-start">
              ...
              <div>
                <h4 className="font-bold text-slate-900 dark:text-white mb-1">
                  Single-Cell Micro-Solenoid
                </h4>
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                  A precision-engineered single Braille cell renders all Grade 1
                  and Grade 2 characters with tactile accuracy in a compact,
          ...
          <div className="bg-gradient-to-br from-brand-teal to-[#1CB8A8] rounded-3xl p-10 md:p-16 shadow-2xl shadow-brand-teal/20 relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="font-display text-4xl md:text-5xl font-bold text-white mb-5 leading-tight">
                Ready to bring Braille
                <br className="hidden sm:block" /> literacy to your classroom?
              </h2>
              <p className="text-white/80 text-lg mb-10 max-w-xl mx-auto">
                Explore the full PinDot ecosystem — from affordable hardware to
                an AI-powered educator dashboard.
              </p>
