...
const values = [
  {
    ...
    desc: "Every design decision is anchored to one goal: making Braille literacy affordable and accessible for low- and middle-income communities worldwide.",
  },
  {
    icon: Globe2,
    title: "Global Reach",
    desc: "We build for the 2.2 billion people experiencing vision impairment — prioritizing those underserved by mainstream assistive technology markets.",
  },
  {
    icon: Heart,
    title: "Learner-First",
    desc: "From the noise-cancellation microphone to the AI curriculum engine, every feature starts with the learner's independence and dignity in mind.",
  },
]
    ...
    <div className="bg-white dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-br from-[#0d4f47] via-[#0f766e] to-brand-teal">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block text-brand-teal text-xs font-bold uppercase tracking-widest mb-6">
            About Us
          </span>
          ...
          <p className="text-xl md:text-2xl text-slate-300 leading-relaxed max-w-3xl mx-auto mb-10">
            We are democratizing tactile literacy globally — bridging the gap in
            assistive technology for low- and middle-income regions, one Braille
            cell at a time.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
            <div>
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-6">
                Commercial Braille displays cost between $500 and several
                thousands of dollars — placing them well out of reach for the
                vast majority of the world's 2.2 billion people with vision
                impairment. That disparity drove us to build PinDot.
              </p>
              <p className="text-slate-600 leading-relaxed">
                Our device combines a single-cell micro-solenoid Braille
                mechanism with voice-driven AI to deliver a full tactile
                literacy curriculum at a fraction of the cost — designed from
                the ground up for learners in the Philippines and beyond.
              </p>
            </div>
            ...
            <div className="space-y-5">
              {values.map((v) => (
                <div
                  key={v.title}
                  className="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-100 dark:border-slate-700 shadow-sm flex gap-5 items-start hover:shadow-md transition-shadow"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 text-lg mt-3 max-w-xl mx-auto">
              A student-led capstone team from Ateneo de Naga University
            ...
            {team.map((member) => (
              ...
              >
                ...
                <div className="relative mb-5">
                  <div
                    className={`w-20 h-20 rounded-2xl ${member.color} flex items-center justify-center font-display font-bold text-2xl shadow-md`}
                  >
                    {member.initials}
                  </div>
                  <span
                    className={`absolute -bottom-2 left-0 text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${member.tagColor}`}
                  >
                    {member.tag}
                  </span>
                </div>
                ...
                <div className="mt-3 flex-1">
                  ...
                  <p className="text-brand-teal text-sm font-semibold mt-0.5">
                    {member.role}
                  </p>
                ...
                <div className="flex gap-2 mt-5 pt-5 border-t border-gray-100">
                  <button
                    className="flex items-center justify-center w-9 h-9 rounded-xl bg-slate-50 text-slate-400 hover:bg-brand-teal/10 hover:text-brand-teal transition-all"
                    aria-label="Email"
                  >
          ...
          <div className="mt-14 bg-gradient-to-r from-brand-teal/8 to-brand-orange/5 border border-brand-teal/15 rounded-2xl p-8 flex flex-col sm:flex-row items-center gap-6 justify-between">
            ...
            <div className="text-slate-600 text-sm max-w-sm text-center sm:text-right">
              PinDot was developed as a BS Computer Engineering capstone
              project, merging embedded systems, AI, and inclusive design.
            </div>
          </div>
        </div>
      </section>
