        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between gap-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-1/2 -translate-x-1/2 mt-1 w-60 bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-700 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 p-2 z-50">
                  ...
                  >
                    ...
                    <span className="bg-brand-teal/10 text-brand-teal text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full">
                      Flagship
                    </span>
                  </a>
                  ...
                  >
                    ...
                    <span className="bg-brand-orange text-white text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full">
                      Soon
                    </span>
                  </a>
                </div>
            ...
            <div className="flex items-center gap-2 md:gap-3 shrink-0">
              ...
              <a
                href="#"
                className="hidden md:block text-sm font-semibold text-slate-700 dark:text-slate-300 hover:text-brand-teal transition-colors px-2 py-2"
              >
                Sign In
              </a>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-950 py-3 px-4 space-y-1">
              ...
              <div className="border-t border-gray-100 pt-3 mt-3 grid grid-cols-2 gap-2">
                <a
                  href="#"
                  className="flex items-center justify-center py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 text-sm font-semibold text-slate-700 dark:text-slate-300 hover:border-brand-teal/40 transition-all"
                >
                  Sign In
                </a>
                <button
        ...
        <footer className="bg-gradient-to-br from-[#0d4f47] via-[#0f766e] to-brand-teal text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="col-span-2 md:col-span-1">
                ...
                <p className="text-white/70 text-sm leading-relaxed mb-5">
                  Democratizing tactile literacy through AI-powered Braille
                  learning technology.
                </p>
              ...
              {/* Product */}
              <div>
                <h4 className="font-bold text-white/90 text-sm uppercase tracking-wider mb-4">
                  Product
                </h4>
              ...
              <div>
                ...
                <ul className="space-y-2.5">
                  <li>
                    <a
                      href="mailto:team@abakadot.edu.ph"
            ...
            <div className="border-t border-white/20 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-white/60 text-sm">
              <span>
                © 2026 Team AbakaDot · Ateneo de Naga University. All rights
                reserved.
              </span>
              <div className="flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-brand-orange animate-pulse" />
                <span className="text-white/80 font-medium">
                  PinDot v1.0 — Now Available
                </span>
              </div>
            </div>
          </div>
